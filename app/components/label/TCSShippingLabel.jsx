...
const TCSShippingLabel = ({ order }) => (
  <Page size={[LABEL_WIDTH, LABEL_HEIGHT]} style={styles.page}>
    <View style={styles.section}>
      ...
      {/* Header: courier name | tracking barcode | date/service/ORGN-DSTN | store logo */}
      ...
      <View style={styles.row}>
        <View style={[styles.column, { width: '40%', padding: 8 }]}>
          ...
          <Text style={{ marginBottom: 4 }}>{order.shipper_details?.name}</Text>
        ...
        <View style={[styles.column, { width: '60%', padding: 8, borderRight: 0 }]}>
          ...
          <Text>{order.destination_address?.city}</Text>
      ...
      <View style={styles.row}>
        ...
        <View style={[styles.row, { width: '60%' }]}>
          ...
          <View style={[styles.column, { width: '30%', padding: 8 }]}>
            ...
            <Text style={[styles.bold, { fontSize: 11 }]}>RS {order.cod_amount}</Text>
          </View>
      ...
      {/* Footer: QR | third barcode | order # | disclaimer */}
      <View style={styles.row}>
        <View style={{ width: '10%' }}>
